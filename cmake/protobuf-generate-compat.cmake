# protobuf's own protobuf_generate()/protobuf_generate_cpp() CMake functions are
# only defined as a byproduct of its INSTALL step (cmake/protobuf-config.cmake.in,
# cmake/protobuf-module.cmake.in -- both processed by configure_file() during
# `make install`). Since GeneralsOnline's dependencies are built via FetchContent
# + add_subdirectory (protobuf_INSTALL is OFF -- no install step runs, and we
# don't want one), those functions never get defined, but GameNetworkingSockets'
# build calls protobuf_generate_cpp() directly. Both functions are copied
# here verbatim from protobuf v21.12's cmake/protobuf-config.cmake.in and
# cmake/protobuf-module.cmake.in; both are self-contained (no @-substitution
# placeholders inside the function bodies themselves), so this is a faithful
