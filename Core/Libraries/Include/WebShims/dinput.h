...
struct IDirectInputDevice8 : IUnknown {
    ...
    virtual HRESULT STDMETHODCALLTYPE SetDataFormat(void*) = 0;
    virtual HRESULT STDMETHODCALLTYPE SetProperty(REFGUID, void*) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDeviceData(DWORD, void*, LPDWORD, DWORD) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetCapabilities(void*) = 0;
    virtual HRESULT STDMETHODCALLTYPE EnumObjects(void*, LPVOID, DWORD) = 0;
};

struct IDirectInput8 : IUnknown {
    virtual HRESULT STDMETHODCALLTYPE CreateDevice(REFGUID, LPDIRECTINPUTDEVICE8*, IUnknown*) = 0;
    virtual HRESULT STDMETHODCALLTYPE EnumDevices(DWORD, void*, LPVOID, DWORD) = 0;
};
...
inline HRESULT DirectInput8Create(HINSTANCE hinst, DWORD dwVersion, REFIID riidltf, LPVOID *ppvOut, IUnknown *punkOuter) { return -1; }
...
#define DIK_NUMPADEQUALS    0x8D    /* = on numeric keypad */
