...
bool GCALL HUFF_is(const void* compresseddata)
{
	...
	if (packtype == 0x30fb || packtype == 0x31fb || packtype == 0x32fb || packtype == 0x33fb || packtype == 0x34fb || packtype == 0x35fb || packtype == 0xb0fb || packtype == 0xb1fb || packtype == 0xb2fb || packtype == 0xb3fb || packtype == 0xb4fb || packtype == 0xb5fb)
		ok = true;
