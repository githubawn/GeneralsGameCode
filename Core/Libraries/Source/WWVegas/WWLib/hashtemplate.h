...
template <class Key>
inline unsigned int HashTemplateKeyClass<Key>::Get_Hash_Value(const Key& k)
{
...
template <>
inline unsigned int HashTemplateKeyClass<float>::Get_Hash_Value(const float& s)
{
...
template <class KeyType, class ValueType>
inline void HashTemplateClass<KeyType, ValueType>::Remove_All()
{
...
template <class KeyType, class ValueType>
inline unsigned int HashTemplateClass<KeyType, ValueType>::Get_Hash_Val(const KeyType& s, const unsigned int hash_array_size)
{
