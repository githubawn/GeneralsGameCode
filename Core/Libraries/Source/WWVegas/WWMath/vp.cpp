...
#define TRANSPOSE(BX, BY, BZ, BW, TV) \
	__asm movaps TV, BZ __asm unpcklps BZ, BW __asm unpckhps TV, BW __asm movaps BW, BX __asm unpcklps BX, BY __asm unpckhps BW, BY __asm movaps BY, BX __asm shufps BX, BZ, SHUFFLE(1, 0, 1, 0) __asm shufps BY, BZ, SHUFFLE(3, 2, 3, 2) __asm movaps BZ, BW __asm shufps BZ, TV, SHUFFLE(1, 0, 1, 0) __asm shufps BW, TV, SHUFFLE(3, 2, 3, 2)
