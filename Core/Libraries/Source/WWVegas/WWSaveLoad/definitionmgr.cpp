...
void DefinitionMgrClass::Prepare_Definition_Array()
{
	...
	if (!DefinitionHash)
		DefinitionHash = W3DNEW HashTemplateClass<StringClass, DynamicVectorClass<DefinitionClass*>*>;
}
...
//
//////////////////////////////////////////////////////////////////////////////////
bool DefinitionMgrClass::Save_Objects(
  ChunkSaveClass& csave)
{
	bool retval = true;
