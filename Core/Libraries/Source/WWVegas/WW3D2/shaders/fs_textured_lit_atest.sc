...
// TheSuperHackers @refactor bobtista 11/04/2026 alpha-tested
...
// the ATest* presets (trees, fences, see-through foliage). Stages
// 1-3 were added later, along with lighting + material diffuse.
//
