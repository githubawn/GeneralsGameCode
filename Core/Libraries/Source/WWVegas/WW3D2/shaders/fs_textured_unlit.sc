...
// TheSuperHackers @refactor bobtista 11/04/2026 unlit textured
// fragment shader. Samples stages 0-3 straight to output. Stages
// 1-3 were added later, along with the material diffuse tint so
