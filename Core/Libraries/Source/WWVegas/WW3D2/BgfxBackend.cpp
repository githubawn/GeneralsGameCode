...
// TheSuperHackers @refactor bobtista 11/04/2026 preset shader
...
void BgfxBackend::Initialize(void * /*hwnd*/, int /*width*/, int /*height*/)
{
    ...
    // TheSuperHackers @refactor bobtista 11/04/2026 build the
...
void BgfxBackend::Set_Shader(const ShaderClass & shader)
{
    ...
    // TheSuperHackers @refactor bobtista 11/04/2026 cache the
