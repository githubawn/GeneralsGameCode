...
// UV animation: texture transform for stage 0.
                      ...
                      unsigned short vertex_count)
{
    ...
    // push the material diffuse (team color + opacity) so
    ...
    // Push TSS operation uniforms so the uber fragment shader
    ...
    // Push alpha test reference. Previously created but never
