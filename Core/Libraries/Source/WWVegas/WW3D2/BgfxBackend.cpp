...
bgfx::TextureHandle EnsureBgfxTexture(TextureBaseClass * tex)
{
    ...
    if (tex->Get_Pool() == TextureBaseClass::POOL_DEFAULT)
    {
        ...
        // reflections). Skip for now — future work will add proper
...
// TheSuperHackers @refactor bobtista 11/04/2026 Set_Shader
                      ...
                      unsigned short vertex_count)
{
    ...
    // Read the CURRENT D3D light state directly from DX8Wrapper's
