...
// Vulkan on Linux, Metal on macOS). Phase 2 provides a stub shell that
// compiles and links against bgfx but implements every virtual method
// as a no-op. Phase 3 will fill in real implementations subsystem by
...
// and C++17. See RENDER_BACKEND.md and PHASE2.md.
