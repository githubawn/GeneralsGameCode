...
void Vector4_to_Color(unsigned int *outc,const Vector4 &inc,const WW3DFormat format)
{
	...
	unsigned int color=DX9Wrapper::Convert_Color(inc);
...
WW3DFormat Get_Valid_Texture_Format(WW3DFormat format, bool is_compression_allowed)
{
	...
	if (!DX9Wrapper::Get_Current_Caps()->Support_DXTC() ||
		...
		case WW3D_FORMAT_DXT1:
			...
			if (!DX9Wrapper::Get_Current_Caps()->Support_Texture_Format(WW3D_FORMAT_DXT1) &&
				DX9Wrapper::Get_Current_Caps()->Support_Texture_Format(WW3D_FORMAT_DXT2)) {
		...
		case WW3D_FORMAT_DXT5:
			if (!DX9Wrapper::Get_Current_Caps()->Support_Texture_Format(format)) format=WW3D_FORMAT_A8R8G8B8;
			break;
		}
	}
	...
	if (!DX9Wrapper::Get_Current_Caps()->Support_Texture_Format(format)) {
