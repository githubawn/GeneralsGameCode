...
//	virtual void OnSlotList( ReturnType ret, LANGameInfo *theGame ) = 0;															///< Slotlist for a game in setup
	...
	virtual Bool isPortRerouted() const { return false; }
	virtual UnsignedShort getRequestedPort() const { return 0; }
	virtual UnsignedShort getBoundPort() const { return 0; }
	virtual UnsignedInt getInstanceOffset() const { return 0; }
