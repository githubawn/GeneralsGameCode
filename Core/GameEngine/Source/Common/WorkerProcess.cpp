...
// TheSuperHackers @build bobtista 29/04/2026 The whole worker-process flow
// uses Win Job Objects and CreateProcess(). Stub on non-Win — the engine only
// uses this for tools (e.g. mapcache rebuild) which we don't ship on macOS.
#ifndef _WIN32
...
#endif // _WIN32 (worker-process Win body)
