	...
	switch (msg)
	{
		...
		*/
		...
		case GWM_MOUSE_LEAVING:
		{
			...
			if (command && (command->getCommandType() == GUI_COMMAND_SPECIAL_POWER || command->getCommandType() == GUI_COMMAND_SPECIAL_POWER_FROM_SHORTCUT) && BitIsSet(command->getOptions(), NEED_TARGET_POS))
				targeting = TRUE;
