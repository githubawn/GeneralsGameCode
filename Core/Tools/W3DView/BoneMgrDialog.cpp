...
//  OnInitDialog
//
BOOL BoneMgrDialogClass::OnInitDialog()
{
...
//  Fill_Bone_Item
//
void BoneMgrDialogClass::Fill_Bone_Item(
...
//	Is_Object_In_List
//
bool BoneMgrDialogClass::Is_Object_In_List(
...
//
void BoneMgrDialogClass::OnSelchangedBoneTree(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
...
//	OnSelchangeObjectCombo
//
void BoneMgrDialogClass::OnSelchangeObjectCombo()
{
...
//	OnDestroy
//
void BoneMgrDialogClass::OnDestroy()
{
...
//	OnCancel
//
void BoneMgrDialogClass::OnCancel()
{
...
//
void BoneMgrDialogClass::Remove_Object_From_Bone(
  HTREEITEM bone_item,
  const CString& name)
{
	// Loop through all the children of this bone
