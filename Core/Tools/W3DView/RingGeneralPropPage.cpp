...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::Initialize()
{
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::Add_Shader_To_Combo(
  ShaderClass& shader,
  LPCTSTR name)
{
...
//
/////////////////////////////////////////////////////////////
BOOL RingGeneralPropPageClass::OnInitDialog()
{
...
//
/////////////////////////////////////////////////////////////
BOOL RingGeneralPropPageClass::OnApply()
{
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnBrowseButton()
{
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnChangeFilenameEdit()
{
	SetModified();
}
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnChangeNameEdit()
{
	SetModified();
}
...
//
/////////////////////////////////////////////////////////////
BOOL RingGeneralPropPageClass::OnNotify(
  WPARAM wParam,
  LPARAM lParam,
  LRESULT* pResult)
{
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnChangeLifetimeEdit()
{
	SetModified();
}
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnSelchangeShaderCombo()
{
	SetModified();
}
...
//
/////////////////////////////////////////////////////////////
BOOL RingGeneralPropPageClass::OnCommand(
  WPARAM wParam,
  LPARAM lParam)
{
...
//
/////////////////////////////////////////////////////////////
void RingGeneralPropPageClass::OnChangeTextureTileEdit()
{
	SetModified();
}
