...
//  OnInitDialog
//
BOOL CEditLODDialog::OnInitDialog()
{
	// Allow the base class to process this message
...
//
void CEditLODDialog::OnDeltaposSwitchUpSpin(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
...
//
void CEditLODDialog::OnDeltaposSwitchDnSpin(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
	NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
...
//
void CEditLODDialog::OnItemChangedHierarchyList(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
...
//
void CEditLODDialog::OnUpdateSwitchDnEdit()
{
