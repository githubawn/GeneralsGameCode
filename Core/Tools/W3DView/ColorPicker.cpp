...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Fill_Rect(
  UCHAR* pbits,
  const RECT& rect,
  COLORREF color,
  int scanline_size)
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Paint_DIB(
  int width,
  int height,
  UCHAR* pbits)
{
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::OnLButtonDown(
  UINT nFlags,
  CPoint point)
{
	SetCapture();
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::OnLButtonUp(
  UINT nFlags,
  CPoint point)
{
	if (m_bSelecting)
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::OnMouseMove(
  UINT nFlags,
  CPoint point)
{
	if (m_bSelecting)
