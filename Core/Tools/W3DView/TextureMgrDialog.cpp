...
//
void TextureMgrDialogClass::Add_Textures_To_Node(
  MeshClass* pmesh,
...
//
void TextureMgrDialogClass::OnDblclkMeshTextureListCtrl(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
...
//
void TextureMgrDialogClass::OnKeydownMeshTextureListCtrl(
  NMHDR* pNMHDR,
  LRESULT* pResult)
{
...
//
void TextureMgrDialogClass::Insert_Texture_Details(
