...
// Create_Bitmap
//
void ColorBarClass::Create_Bitmap()
{
	// Start fresh
	Free_Bitmap();
...
// Free_Bitmap
//
void ColorBarClass::Free_Bitmap()
{
...
// Paint_Bar_Vert
//
void ColorBarClass::Paint_Bar_Vert(
  int x_pos,
  int y_pos,
  int width,
  int height,
...
// Paint_Bar_Horz
//
void ColorBarClass::Paint_Bar_Horz(
  int x_pos,
  int y_pos,
  int width,
  int height,
...
// Insert_Point
//
bool ColorBarClass::Insert_Point(
  int index,
  float position,
  float red,
  float green,
...
// Modify_Point
//
bool ColorBarClass::Modify_Point(
  int index,
  float position,
  float red,
  float green,
...
// Free_Marker_Bitmap
//
void ColorBarClass::Free_Marker_Bitmap()
{
...
// Load_Key_Frame_BMP
//
void ColorBarClass::Load_Key_Frame_BMP()
{
	Free_Marker_Bitmap();
...
// OnLButtonDown
//
void ColorBarClass::OnLButtonDown(
  UINT nFlags,
  CPoint point)
{
	//
...
// OnLButtonUp
//
void ColorBarClass::OnLButtonUp(
  UINT nFlags,
  CPoint point)
{
	if (m_bMoving)
...
// OnMouseMove
//
void ColorBarClass::OnMouseMove(
  UINT nFlags,
  CPoint point)
{
	if (m_bMoving)
...
// OnLButtonDblClk
//
void ColorBarClass::OnLButtonDblClk(
  UINT nFlags,
  CPoint point)
{
	int marker_clicked = Marker_From_Point(point);
