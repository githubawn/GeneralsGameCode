...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Display_Emitter(
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::DisplayObject(
...
void CW3DViewDoc::ResetAnimation()
{
	if (m_pCAnimation != nullptr)
	{
		...
		//
		((CMainFrame*)::AfxGetMainWnd())->UpdateFrameCount(0, m_pCAnimation->Get_Num_Frames() - 1, frame_rate * anim_speed);
	}
}
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::PlayAnimation(
  RenderObjClass* pCModel,
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Play_Animation_Sound()
{
	if (m_pCAnimation != nullptr)
	{
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Update_Camera()
{
...
//
///////////////////////////////////////////////////////////////
bool CW3DViewDoc::Save_Selected_Emitter()
{
	// Assume failure
	bool retval = false;
...
//
///////////////////////////////////////////////////////////////
bool CW3DViewDoc::Save_Selected_Sound_Object()
{
	bool retval = false;
...
//
///////////////////////////////////////////////////////////////
bool CW3DViewDoc::Save_Selected_Aggregate()
{
	// Assume failure
	bool retval = false;
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Build_Emitter_List(
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Save_Camera_Settings()
{
...
//
///////////////////////////////////////////////////////////////
void CW3DViewDoc::Load_Camera_Settings()
{
