...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Initialize()
{
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnInitDialog()
{
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnApply()
{
	// Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::OnDestroy()
{
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnNotify(
  WPARAM wParam,
  LPARAM lParam,
  LRESULT* pResult)
{
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::OnCancel()
{
	//
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Update_Opacities()
{
	m_AlphaChannel.Reset();
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Update_Colors()
{
	m_ColorChannel.Reset();
