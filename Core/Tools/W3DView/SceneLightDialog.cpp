...
//  OnHScroll
//
void CSceneLightDialog::OnHScroll(
  UINT nSBCode,
  UINT nPos,
...
//  OnChannelBothRadio
//
void CSceneLightDialog::OnChannelBothRadio()
{
...
//
void CSceneLightDialog::OnChannelDiffuseRadio()
{
...
//
void CSceneLightDialog::OnChannelSpecularRadio()
{
...
//  Update_Attenuation
//
void CSceneLightDialog::Update_Attenuation()
{
	// Get a pointer to the document so we can change the scene light's
	// settings
	CW3DViewDoc* pCDoc = ::GetCurrentDocument();
...
//  Update_Attenuation_Controls
//
void CSceneLightDialog::Update_Attenuation_Controls()
{
