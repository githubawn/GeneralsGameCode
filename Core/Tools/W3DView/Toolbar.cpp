...
//  RegisterFancyToolbarClass
//
void CFancyToolbar::RegisterFancyToolbarClass()
{
...
//  HandleLButtonUp
//
void CFancyToolbar::OnLButtonDown(
  UINT nFlags,
  CPoint point)
{
...
//  HandleLButtonUp
//
void CFancyToolbar::OnLButtonUp(
  UINT nFlags,
  CPoint point)
{
...
//  SetButtonState
//
void CFancyToolbar::SetButtonState(
  int iCommandID,
  STATE_INFO newState,
  BOOL bRepaint)
{
