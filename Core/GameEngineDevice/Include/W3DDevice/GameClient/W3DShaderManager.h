...
public:
	...
	static void pushLightMapToBackend(Bool enabled, TextureClass * noiseTex);	///<push cloud scroll + stretch + texture to g_renderBackend (bgfx modulates in uber shader).
