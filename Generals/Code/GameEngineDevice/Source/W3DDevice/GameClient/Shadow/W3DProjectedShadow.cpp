...
Bool W3DProjectedShadowManager::ReAcquireResources()
{
	...
	DEBUG_ASSERTCRASH(shadowDecalIndexBufferD3D == nullptr, ("ReAcquireResources not released in W3DProjectedShadowManager"));

	if (FAILED(DX8Wrapper::_CreateIndexBuffer(
	...
	{	// Create vertex buffer
		...
		if (FAILED(DX8Wrapper::_CreateVertexBuffer(
...
/*						if (flipForBlend)
		...
		DX8Wrapper::Set_Transform(D3DTS_WORLD,(_D3DMATRIX *)&mWorld);
...
/*	UnsignedInt color=TheW3DShadowManager->getShadowColor();
	DX8Wrapper::Set_DX8_Render_State( D3DRS_TEXTUREFACTOR, 0xff000000 | color);
...
//	DX8Wrapper::Set_DX8_Render_State(D3DRS_DESTBLEND,D3DBLEND_SRCCOLOR);	//restore W3D state
//	DX8Wrapper::Set_DX8_Render_State(D3DRS_SRCBLEND, D3DBLEND_ZERO);
