...
void RoadType::loadTexture(AsciiString path, Int ID)
{
	...
	m_vertexRoad=NEW_REF(DX9VertexBufferClass,(DX9_FVF_XYZDUV1,TheGlobalData->m_maxRoadVertex+4,DX9VertexBufferClass::USAGE_DYNAMIC));
	m_indexRoad=NEW_REF(DX9IndexBufferClass,(TheGlobalData->m_maxRoadIndex+4, DX9IndexBufferClass::USAGE_DYNAMIC));
	m_numRoadVertices=0;
	m_numRoadIndices=0;
