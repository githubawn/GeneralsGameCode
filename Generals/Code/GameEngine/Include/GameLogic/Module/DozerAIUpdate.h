...
//-------------------------------------------------------------------------------------------------
enum DozerTask CPP_11( : Int
)    // These enums are saved in the game save file, so DO NOT renumber them. jba.
{
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
enum DozerDockPoint CPP_11( : Int
)    // These enums are saved in the game save file, so DO NOT renumber them. jba.
{
...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
enum DozerBuildSubTask CPP_11( : Int
)    // These enums are saved in the game save file, so DO NOT renumber them. jba.
{
