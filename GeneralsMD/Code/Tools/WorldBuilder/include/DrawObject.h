...
public:
	...
	void setDrawObjects(Bool val, Bool waypoints, Bool poly, Bool bounding, Bool sight, Bool weapon, Bool sound, Bool testart, Bool letterbox)
	{
		...
		m_drawTestArtHighlight = testart, m_drawLetterbox = letterbox;
	}
	static void setDoBrushFeedback(Bool val)
	{
		m_toolWantsFeedback = val;
		m_meshFeedback = false;
	}
	...
	{
		m_squareFeedback = square;
		m_brushWidth = width;
		m_meshFeedback = false;
		m_brushFeatherWidth = featherWidth;
	}
...
protected:
	...
	{
		MAX_RADIUS = 50,
		NUM_FEEDBACK_VERTEX = 201 * 201,
		NUM_FEEDBACK_INDEX = 101 * 101 * 6
	};
