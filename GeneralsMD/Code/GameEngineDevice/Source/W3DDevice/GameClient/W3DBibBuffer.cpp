...
void W3DBibBuffer::loadBibsInVertexAndIndexBuffers()
{
	...
	UnsignedShort *ib;
	// Lock the buffers.
	DX9IndexBufferClass::WriteLockClass lockIdxBuffer(m_indexBib, D3DLOCK_DISCARD);
	DX9VertexBufferClass::WriteLockClass lockVtxBuffer(m_vertexBib, D3DLOCK_DISCARD);
