...
void W3DBibBuffer::loadBibsInVertexAndIndexBuffers()
{
	...
	UnsignedShort *ib;
	// Lock the buffers.
	IndexBufferClass::WriteLockClass lockIdxBuffer(m_indexBib, WW3D_LOCK_DISCARD);
	VertexBufferClass::WriteLockClass lockVtxBuffer(m_vertexBib, WW3D_LOCK_DISCARD);
