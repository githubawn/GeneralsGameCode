...
protected:
	...
	IndexBufferClass			*m_indexBuffer;	//indices defining a triangle strip the covers full terrain
	ShaderClass m_shaderClass; //shader or rendering state for heightmap
	VertexMaterialClass	  	  *m_vertexMaterialClass;
	VertexBufferClass	*m_vertexBufferCircle;	//collection of vertexes that make the circle.
	VertexBufferClass	*m_vertexBufferScreen;	//2 triangle quad that covers the screen.
