...
#include "dx8fvf.h" // for VertexFormatXYZDUV1
#include "shader.h"
...
protected:
	...
	VertexBufferClass	*m_vertexRoad;	///<Road vertex buffer.
	IndexBufferClass			*m_indexRoad;	///<indices defining a triangles for the road drawing.
...
public:
	...
	VertexBufferClass	*getVB() {return m_vertexRoad;};
	IndexBufferClass		*getIB() {return m_indexRoad;}
