...
// TheSuperHackers @build bobtista 13/06/2026 Renamed from 'pause' to avoid
// clashing with the POSIX pause() function declared in <unistd.h>.
static Bool s_popupPaused = FALSE;
//-----------------------------------------------------------------------------
// PUBLIC FUNCTIONS ///////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
