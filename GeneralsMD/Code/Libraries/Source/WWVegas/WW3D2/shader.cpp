	...
	if (diff & pri_mask)
	{
		    ...
		    ((SecaOp != D3DTOP_DISABLE) || (SeccOp != D3DTOP_DISABLE)))
		{
			...
			if ((PricOp == D3DTOP_SELECTARG1) && (PricArg1 == D3DTA_DIFFUSE))
			{
				...
				if (SeccArg2 == D3DTA_CURRENT)
					SeccArg2 = D3DTA_DIFFUSE;
				if (SecaArg2 == D3DTA_CURRENT)
					SecaArg2 = D3DTA_DIFFUSE;
				// and nuke stage 2
				kill_stage_2 = true;
			}
			else
...
const StringClass& ShaderClass::Get_Description(StringClass& str) const
{
	...
	{
		case PASS_NEVER:
			str += "DEPTH_COMPARE:PASS_NEVER | ";
			break;
		case PASS_LESS:
			str += "DEPTH_COMPARE:PASS_LESS | ";
			break;
		case PASS_EQUAL:
			str += "DEPTH_COMPARE:PASS_EQUAL | ";
			break;
		case PASS_LEQUAL:
			str += "DEPTH_COMPARE:PASS_LEQUAL | ";
			break;
		case PASS_GREATER:
			str += "DEPTH_COMPARE:PASS_GREATER | ";
			break;
		case PASS_NOTEQUAL:
			str += "DEPTH_COMPARE:PASS_NOTEQUAL | ";
			break;
		case PASS_GEQUAL:
			str += "DEPTH_COMPARE:PASS_GEQUAL | ";
			break;
		case PASS_ALWAYS:
			str += "DEPTH_COMPARE:PASS_ALWAYS | ";
			break;
	}
	...
	switch (Get_Depth_Mask())
	{
		case DEPTH_WRITE_DISABLE:
			str += "DEPTH_WRITE_DISABLE | ";
			break;
		case DEPTH_WRITE_ENABLE:
			str += "DEPTH_WRITE_ENABLE | ";
			break;
	}

	switch (Get_Color_Mask())
	{
		case COLOR_WRITE_DISABLE:
			str += "COLOR_WRITE_DISABLE | ";
			break;
		case COLOR_WRITE_ENABLE:
			str += "COLOR_WRITE_ENABLE | ";
			break;
	}
	...
	switch (Get_Dst_Blend_Func())
	{
		...
		case DSTBLEND_SRC_COLOR:
			str += "DSTBLEND_SRC_COLOR | ";
			break;
		case DSTBLEND_ONE_MINUS_SRC_COLOR:
			str += "DSTBLEND_ONE_MINUS_SRC_COLOR | ";
			break;
		case DSTBLEND_SRC_ALPHA:
			str += "DSTBLEND_SRC_ALPHA | ";
			break;
		case DSTBLEND_ONE_MINUS_SRC_ALPHA:
			str += "DSTBLEND_ONE_MINUS_SRC_ALPHA | ";
			break;
	}
	...
	switch (Get_Primary_Gradient())
	{
		case GRADIENT_DISABLE:
			str += "GRADIENT_DISABLE | ";
			break;
		case GRADIENT_MODULATE:
			str += "GRADIENT_MODULATE | ";
			break;
		case GRADIENT_ADD:
			str += "GRADIENT_ADD | ";
			break;
		case GRADIENT_BUMPENVMAP:
			str += "GRADIENT_BUMPENVMAP | ";
			break;
		case GRADIENT_BUMPENVMAPLUMINANCE:
			str += "GRADIENT_BUMPENVMAPLUMINANCE | ";
			break;
		case GRADIENT_MODULATE2X:
			str += "GRADIENT_MODULATE2X | ";
			break;
	}
	...
	switch (Get_Secondary_Gradient())
	{
		case SECONDARY_GRADIENT_DISABLE:
			str += "SECONDARY_GRADIENT_DISABLE | ";
			break;
		case SECONDARY_GRADIENT_ENABLE:
			str += "SECONDARY_GRADIENT_ENABLE | ";
			break;
	}
	...
	switch (Get_Src_Blend_Func())
	{
		...
		case SRCBLEND_SRC_ALPHA:
			str += "SRCBLEND_SRC_ALPHA | ";
			break;
		case SRCBLEND_ONE_MINUS_SRC_ALPHA:
			str += "SRCBLEND_ONE_MINUS_SRC_ALPHA | ";
			break;
	}
	...
	switch (Get_Texturing())
	{
		case TEXTURING_DISABLE:
			str += "TEXTURING_DISABLE | ";
			break;
		case TEXTURING_ENABLE:
			str += "TEXTURING_ENABLE | ";
			break;
	}
	...
	switch (Get_Alpha_Test())
	{
		case ALPHATEST_DISABLE:
			str += "ALPHATEST_DISABLE | ";
			break;
		case ALPHATEST_ENABLE:
			str += "ALPHATEST_ENABLE | ";
			break;
	}
	...
	switch (Get_Cull_Mode())
	{
		case CULL_MODE_DISABLE:
			str += "CULL_MODE_DISABLE | ";
			break;
		case CULL_MODE_ENABLE:
			str += "CULL_MODE_ENABLE | ";
			break;
	}
	...
	switch (Get_Post_Detail_Color_Func())
	{
		case DETAILCOLOR_DISABLE:
			str += "DETAILCOLOR_DISABLE";
			break;
		case DETAILCOLOR_DETAIL:
			str += "DETAILCOLOR_DETAIL";
			break;
		case DETAILCOLOR_SCALE:
			str += "DETAILCOLOR_SCALE";
			break;
		case DETAILCOLOR_INVSCALE:
			str += "DETAILCOLOR_INVSCALE";
			break;
		...
		case DETAILCOLOR_SUBR:
			str += "DETAILCOLOR_SUBR";
			break;
		case DETAILCOLOR_BLEND:
			str += "DETAILCOLOR_BLEND";
			break;
		case DETAILCOLOR_DETAILBLEND:
			str += "DETAILCOLOR_DETAILBLEND";
			break;
		case DETAILCOLOR_ADDSIGNED:
			str += "DETAILCOLOR_ADDSIGNED";
			break;
		case DETAILCOLOR_ADDSIGNED2X:
			str += "DETAILCOLOR_ADDSIGNED2X";
			break;
		case DETAILCOLOR_SCALE2X:
			str += "DETAILCOLOR_SCALE2X";
			break;
		case DETAILCOLOR_MODALPHAADDCOLOR:
			str += "DETAILCOLOR_MODALPHAADDCOLOR";
			break;
	}
	return str;
}
